...
WHERE Tweet.tweet_id = Comment.tweet_id AND user_id = replyer_id AND Location.location_id = User.location_id AND poster_id = '.$_SESSION['userid'].' ORDER BY Comment.time DESC';
